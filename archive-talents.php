...
?>
	...
	<main id="primary" class="site-main top-spaced-with-filters talents-page">

     <section class="container-fluid" style="min-height:calc(100vh - 50px)">
		<div class="row">
		<script>
		...
		if ( $result->have_posts() ) :
			...
			while ( $result->have_posts() ) :
				 ...
				 */
				get_template_part( 'template-parts/content-talents', get_post_type() );
