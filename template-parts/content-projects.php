...
<div class="projects-column">
	...
	<?php }?>
	<?php if($video){?>
		<div class="projects-video-wrapper">
			<video class="projects-video" src="<?php echo $video ?>" autoplay loop muted playsinline />
		</div>
	<?php } else {?>
			<?php echo the_post_thumbnail();?>
	<?php }?>
	<a href="<?php echo get_permalink($post->ID)?>" class="projects-column-content">
