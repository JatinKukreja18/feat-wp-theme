		...
		<main id="main" class="site-main ">
			<div class="section-wrapper"> 
					<section class="section active " id="slide-1">
						<div class="feat-home-banner">
                            <div class="feat-home-banner-image">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homepage/slide1/1.jpg" alt="" srcset="" style="z-index:1">
                                <img src=" <?php echo get_stylesheet_directory_uri(); ?>/images/homepage/slide1/2.jpg" alt="" srcset="">
                                <img src=" <?php echo get_stylesheet_directory_uri(); ?>/images/homepage/slide1/3.jpg" alt="" srcset="">
                                <img src=" <?php echo get_stylesheet_directory_uri(); ?>/images/homepage/slide1/4.jpg" alt="" srcset="">
							...
							<div class="feat-home-banner-content">
								...
								<div class="feat-banner-slide-content">
                                    ...
                                    Sabyasachi feat. 
                                    <a href="<?php echo  home_url( '/' ).'models/sana'; ?>">Sana</a>, 
                                    <a href="<?php echo  home_url( '/' ).'models/kripali'; ?>">Kripali</a> and 
                                    <a href="<?php echo  home_url( '/' ).'models/karanjit'; ?>">Karanjit</a> Photographed by Farhan Hussain
                                    </h1>
									<a class="main-cta" href="<?php echo  home_url( '/' ).'models'; ?>" onmouseover="runImageSlideshow(1)"  onmouseout="stopImageSlideshow()">
										Explore
									</a>
						...
						<div class="feat-home-banner full">
							...
							<div class="feat-home-banner-content">
								...
								<div class="feat-banner-slide-content">
									...
									<h1 >
                                        Satya Paul feat. <a href="<?php echo  home_url( '/' ).'models/anugraha'; ?>">Anugraha</a> Filmed by Tenzin Tsundue Phunkhang, Styled by Nikhil D
                                    </h1>
									<a  class="main-cta" href="<?php echo  home_url( '/' ).'models/anugraha'; ?>">
										Explore
									</a>
                        ...
                        <div class="feat-home-banner gray-box">
							...
							<div class="feat-home-banner-content">
								...
								<div class="feat-banner-slide-content">
                                    ...
                                    Vogue India Cover Photographed by Bikramjit Bose, Beauty by Mitesh Rajani feat. 
                                    <a href="<?php echo  home_url( '/' ).'models/shruti'; ?>">Shruti</a> & 
                                    Haima
                                    </h1>
									<a  class="main-cta" href="<?php echo  home_url( '/' ).'models'; ?>" >
										Explore
									</a>
										<!-- href="<php echo get_permalink($post->ID)?>"> -->
								</div>
                    ...
                    <section class="section " id="slide-4">
                        <div class="feat-home-banner full">
                            <div class="feat-home-banner-image">
                                <video autoplay nocontrols preload="meta"  loop="loop" muted="" playsinline="" src="<?php echo get_stylesheet_directory_uri(); ?>/images/homepage/bianca_saunders.mp4" alt="" srcset="" style="z-index:1">
                                <!-- <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homepage/Homepage-option-2---Sabyasachi.jpg" alt="" srcset=""> -->
							...
							<div class="feat-home-banner-content">
								...
								<div class="feat-banner-slide-content">
									...
									<h1 >
                                    Bianca Saunders feat. <a href="<?php echo  home_url( '/' ).'models/kangkan'; ?>">Kangkan</a>
                                </h1>
									<a  class="main-cta" href="<?php echo  home_url( '/' ).'models/kangkan'; ?>">
										Explore
									</a>
										<!-- href="<php echo get_permalink($post->ID)?>"> -->
								</div>
                    ...
                    <section class="section " id="slide-5">
						<div class="feat-home-banner gray-box">
                            <div class="feat-home-banner-image">
                                <div class="feat-aspect-container">
                                    <div class="aspect-4-3">
                                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/homepage/Models.jpg" alt="" srcset="" style="z-index:1">                 
                                    </div>
                                </div>
                            </div>
							<div class="feat-home-banner-content">
								...
								<div class="feat-banner-slide-content">
									...
									<h1 onmouseover="runImageSlideshow(4)" onmouseout="stopImageSlideshow()">
                                    All Saints Campaign feat. <a href="<?php echo  home_url( '/' ).'models/priya-j'; ?>">Priya J</a> Photographed by Daniel Jackson Casted by Arqa Casting

                                    </h1>
									<a  class="main-cta" href="<?php echo  home_url( '/' ).'models/priya-j'; ?>">
										Explore
									</a>
										<!-- href="<php echo get_permalink($post->ID)?>"> -->
								</div>
